...
public class cBluetooth{
    ...
    public final static int BL_NOT_AVAILABLE = 1;        	// Bluetooth cortlamış
    public final static int BL_INCORRECT_ADDRESS = 2;		// adres yanlış hacı
    public final static int BL_REQUEST_ENABLE = 3;			// bluetoothu açak mı
